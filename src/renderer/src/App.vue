...
<template>
  ...
  <p class="desc">
    What features are being added to the project to help you develop, build and
    pack Electron app
  </p>
    ...
    <ul>
      <li>
        <p>
          ...
          to better lint and style your code, help you to write high-quality
          code.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          ...
          that make you easy to develop. For example: TSconfigs extends, expose
          common Electron APIs to renderers in preload scripts and effective
          utils for the main process.
        </p>
      </li>
      <li>
        <p>
          ...
          and preset common configuration, allows you to easily pack Electron
          app.
        </p>
      </li>
      <li>
